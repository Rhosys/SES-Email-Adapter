...
import { Label as LabelSchema, ListLabelsResponse, ErrorCode } from "./schemas.js";
import type { AccountDatabase } from "../database/account-database.js";
import type { AppEnv } from "./app.js";

type ErrorCodeLiteral = z.infer<typeof ErrorCode>;

export interface LabelsApiDeps {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function registerLabelsRoutes(app: OpenAPIHono<any>, deps: LabelsApiDeps): void {
  const { accountDb, authz, err, route } = deps;
