...
export interface DomainsApiDeps {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function registerDomainsRoutes(app: OpenAPIHono<any>, deps: DomainsApiDeps): void {
  const { accountDb, domainIdentityService, logger, authz, err, route } = deps;
