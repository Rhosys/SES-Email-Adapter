...
import { View as ViewSchema, ListViewsResponse, ErrorCode } from "./schemas.js";
import type { AccountDatabase } from "../database/account-database.js";
import type { AppEnv } from "./app.js";

type ErrorCodeLiteral = z.infer<typeof ErrorCode>;

export interface ViewsApiDeps {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function registerViewsRoutes(app: OpenAPIHono<any>, deps: ViewsApiDeps): void {
