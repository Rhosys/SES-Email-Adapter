...
export const SYSTEM_RULES: Rule[] = [
  ...
  { id: "SR-02", accountId: "SYSTEM", name: "Show onboarding emails with action URL in quarantine", condition: JSON.stringify({ "and": [in_("system:workflow:onboarding"), { "!!": [wfData_("actionUrl")] }] }), actions: [{ type: "quarantine_visible" }], status: "enabled", priorityOrder: 150, createdAt: "", updatedAt: "" },
  { id: "SR-03", accountId: "SYSTEM", name: "Block onboarding emails", condition: JSON.stringify(in_("system:workflow:onboarding")), actions: [{ type: "quarantine_hidden" }], status: "enabled", priorityOrder: 200, createdAt: "", updatedAt: "" },
  { id: "SR-04", accountId: "SYSTEM", name: "Block notice emails", condition: JSON.stringify(in_("system:workflow:notice")), actions: [{ type: "block_hidden" }], status: "enabled", priorityOrder: 300, createdAt: "", updatedAt: "" },
  ...
  { id: "SR-08", accountId: "SYSTEM", name: "Suppress notification for notice emails", condition: JSON.stringify(in_("system:workflow:notice")), actions: [{ type: "suppress_notification" }], status: "enabled", priorityOrder: 700, createdAt: "", updatedAt: "" },
  { id: "SR-09", accountId: "SYSTEM", name: "Suppress notification for content emails", condition: JSON.stringify(in_("system:workflow:content")), actions: [{ type: "suppress_notification" }], status: "enabled", priorityOrder: 800, createdAt: "", updatedAt: "" },
  ...
  { id: "SR-18", accountId: "SYSTEM", name: "Auto-reply to test emails (pong)", condition: JSON.stringify(in_("system:test")), actions: [{ type: "pong" }], status: "enabled", priorityOrder: 1700, createdAt: "", updatedAt: "" },
