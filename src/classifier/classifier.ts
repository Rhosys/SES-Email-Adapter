...
{ "workflow": "crm", "senderCompany": "<string or null>", "senderRole": "<string or null>" }

### conversation
Direct human-to-human correspondence not generated by automated systems
{ "workflow": "conversation", "sentiment": "positive"|"neutral"|"negative"|"urgent", "requiresReply": true|false }
