...
- [ ] **Auto-block "think before you click" warning emails from service providers** — many banks and other systems now send out emails to consumers warning them about clicking malicious links or stuff to do with not giving out your password or credentials. All of these are complete noise and complete garbage and should be dealt with accordingly.
