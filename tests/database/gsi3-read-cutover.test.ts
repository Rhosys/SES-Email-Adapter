  ...
  it.each([
    {
      ...
      returnedItem: {
        ...
        senderAddress: "shop@example.com", recipientAddress: "me@example.com", subject: "Your order",
      },
    ...
    },
    {
      ...
      returnedItem: {
        ...
        senderAddress: "billing@corp.com", recipientAddress: "user@example.com", subject: "Invoice",
      },
      expectedThreadId: "thr-legacy",
    },
