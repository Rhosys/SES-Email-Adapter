...
describe("SignalProcessor integration: end-to-end retry flow", () => {
  ...
  beforeEach(() => {
    ...
    processor = new SignalProcessor({ resourceDb: resourceDb as never, ...makeSharedNewDeps(),
      ...
      contentSanitizer, emailContentStore: { getSignedUrl: vi.fn().mockResolvedValue("https://signed-url"), getObject: vi.fn().mockResolvedValue(new Uint8Array([1, 2, 3])), putObject: vi.fn().mockResolvedValue(undefined), getPresignedPost: vi.fn().mockResolvedValue({ url: "https://post-url", fields: {} }) } as never, contentStore: { getSignedUrl: vi.fn().mockResolvedValue("https://signed-url"), getObject: vi.fn().mockResolvedValue(new Uint8Array([1, 2, 3])), putObject: vi.fn().mockResolvedValue(undefined), getPresignedPost: vi.fn().mockResolvedValue({ url: "https://post-url", fields: {} }) } as never,
      classifier,
      embeddingGenerator,
      auroraWriter,
      threadMatcher,
