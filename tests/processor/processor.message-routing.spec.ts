...
describe("IncomingEmailProcessor message routing", () => {
  ...
  beforeEach(() => {
    ...
    processor = new IncomingEmailProcessor({ resourceDb: { saveResource: async () => ok(undefined) } as never, ...makeSharedNewDeps(),
