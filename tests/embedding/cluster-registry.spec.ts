...
function makeRegistryEntry(overrides: Partial<import("../../src/embedding/cluster-registry.js").ClusterRegistryEntry> = {}): import("../../src/embedding/cluster-registry.js").ClusterRegistryEntry {
  return {
